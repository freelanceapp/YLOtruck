...
public class WelcomeSrceenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textskip = findViewById(R.id.tv_text_skip);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(WelcomeSrceenActivity.this, MobileRegistration.class));
        finish();
    }
